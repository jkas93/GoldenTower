...
export class ProjectsController {
  ...
  @Get(':id/health')
  async getProjectHealth(@Param('id') id: string, @Request() req: any) {
  ...
  async getMilestones(
    ...
    return this.projectsService.getMilestones(
      projectId,
      req.user.uid,
      req.user.role,
    );
  ...
  async addTask(
    ...
    const id = await this.projectsService.addTask(
      projectId,
      taskData as any,
      req.user.uid,
      req.user.role,
  ...
  async updateTask(
    ...
    await this.projectsService.updateTask(
      projectId,
      taskId,
      taskData as any,
      req.user.uid,
