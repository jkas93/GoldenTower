...
async function cleanupDuplicates() {
    try {
        console.log('ðŸš€ Iniciando limpieza de duplicados...\n');
        ...
        if (!response.ok) {
            ...
            console.error('âŒ Error:', errorData);
            return;
        }
        ...
        console.log('\nðŸ“ Detalles de registros eliminados:');
        ...
        console.error('âŒ Error ejecutando la limpieza:', error.message);
    }
}
